      ...
      <div className="box-animation">
        <div className="Header">
          <svg className="Header__svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1337.97 684.43">
            ...
            <path className="Header__shape littleSquare" fill="#5779e0" d="M285.523 262.61l12.372-53.59 53.59 12.372-12.372 53.59z" />
            <circle className="Header__shape hoop" fill="none" stroke="#ffe430" strokeWidth="13" cx="905.52" cy="447.17" r="45" />
            <circle className="Header__shape littleCircle" fill="#5779e0" cx="1036.52" cy="203.17" r="27" />
          </svg>
        </div>
      </div>
...
export default RhombusAnimation;
